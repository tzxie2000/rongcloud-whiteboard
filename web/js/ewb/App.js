    ...
    components: [{
        ...
        components: [{
            ...
            components: [{
                ...
                style: "margin:0 auto auto; background-color: #FFFFFF;display:inline-block;",
                ontap: "appclicked",
        ...
        components: [{
                ...
                components: [{
                    ...
                    components: [{
                        ...
                        style: "background:url(images/wb.svg) -37px -24px no-repeat transparent;cursor:pointer;margin:5px 2px 20px;"
                    }, {
                        kind: "onyx.Menu",
                        components: [{
                            name: "upload",
                ...
                components: [{
                    ...
                    style: "background:url(images/wb.svg);background-repeat:no-repeat;background-color:transparent;background-position:-37px -159px;cursor:pointer;"
                }, {
                    kind: "onyx.Tooltip",
                    content: $L("Zoom In"),
                    classes: "above",
                ...
                components: [{
                    kind: "onyx.Button",
                    name: "zoomOutButton",
                    style: "background:url(images/wb.svg);background-repeat:no-repeat;background-color:transparent;background-position:-37px -113px;cursor:pointer;",
                    ontap: "zoomOutPane",
                ...
                components: [{
                    ...
                    style: "background:url(images/wb.svg);background-repeat:no-repeat;background-color:transparent;background-position:-39px -664px;cursor:pointer;margin:5px 0 20px;",
                }, {
                    kind: "onyx.Tooltip",
                ...
                components: [{
                    ...
                    ontap: "selectClear",
                    style: "background:url(images/wb.svg);background-repeat:no-repeat;background-color:transparent;background-position:-39px -620px;height:25px;cursor:pointer;margin:5px 0 20px;",
                }, {
                    kind: "onyx.Tooltip",
                ...
                components: [{
                    ...
                    kind: "onyx.Button",
                    ontap: "selectEraser",
                    style: "background:url(images/wb.svg);background-repeat:no-repeat;background-color:transparent;background-position:-37px -574px;height:25px;cursor:pointer;margin:5px 0 20px;",
                ...
                components: [{
                    ...
                    style: "background:url(images/wb.svg);background-repeat:no-repeat;background-color:transparent;background-position:-37px -529px;height:25px;cursor:pointer;margin:5px 0 20px;",
                }, {
                    kind: "onyx.Tooltip",
                    content: $L("Undo"),
                    classes: "above"
                ...
                components: [{
                    ...
                    style: "background:url(images/wb.svg);background-repeat:no-repeat;background-color:transparent;background-position:-37px -485px;height:25px;cursor:pointer;margin:5px 0 20px;",
                }, {
                    kind: "onyx.Tooltip",
                    content: $L("Redo"),
                    classes: "above"
            ...
            //},
            {
                ...
                components: [{
                    ...
                    style: "background:url(images/wb.svg);background-repeat:no-repeat;background-color:transparent;background-position:-38px -438px;height:25px;cursor:pointer;margin:5px 0 20px;",
                }, {
                    kind: "onyx.Tooltip",
                    content: $L("Select"),
                    classes: "above"
                ...
                components: [{
                    ...
                    style: "background:url(images/wb.svg);background-repeat:no-repeat;background-color:transparent;background-position:-40px -392px;cursor:pointer;margin:5px 0 20px;",
                }, {
                    kind: "onyx.Tooltip",
                    content: $L("Laser"),
                    classes: "above",
                ...
                components: [{
                    ...
                    components: [{
                        ...
                        style: "width:38px;background:url(images/wb.svg);background-repeat:no-repeat;background-position:-39px -353px; background-color:transparent;height:30px;padding:0;cursor:pointer;margin:5px 0 20px;",
                    }, {
                        kind: "onyx.Picker",
                        maxHeight: "400px",
                        components: [{
            ...
            //},
            {
                ...
                components: [{
                    ...
                    ontap: "addText",
                    style: "background:url(images/wb.svg);background-repeat:no-repeat;background-color:transparent;background-position:-39px -311px;cursor:pointer;margin:5px 0 20px;",
                }, {
                    kind: "onyx.Tooltip",
                    content: $L("Add Text"),
                    classes: "above",
                ...
                components: [{
                    ...
                    style: "background:url(images/wb.svg);background-repeat:no-repeat;background-color:transparent;background-position:-37px -269px;height:25px;cursor:pointer;margin:5px 0 20px;",
                ...
                components: [{
                    ...
                    style: "background:url(images/wb.svg);background-repeat:no-repeat;background-color:transparent;background-position:-115px -228px;height:25px;cursor:pointer;margin:5px 0 20px;",
                    ontap: "selectPen",
                }, {
                    kind: "onyx.Tooltip",
                    content: $L("Pen"),
                ...
                components: [{
                    ...
                    components: [{
                        ...
                        kind: "onyx.Button",
                        style: "width: 40px;background:url(images/wb.svg);background-repeat:no-repeat;background-position:-37px -204px;background-color:transparent;height:25px;cursor:pointer;margin:15px 10px 20px",
                    }, {
                        kind: "onyx.Picker",
                        maxHeight: "400px",
                        components: [{
...
//                }
    ...
    closeEraser: function() {
        ...
        this.$.eraser.applyStyle("background-position", "-50px -586px");
    },
    ...
    hideLaser: function() {
        ...
        this.$.laserPen.applyStyle("background-position", "-40px -392px");
    },
    ...
    openHighlighter: function() {
        ...
        this.$.highlighter.applyStyle("background-position", "-113px -269px");
    ...
    closeHighlighter: function() {
        ...
        this.$.highlighter.applyStyle("background-position", "-37px -269px");
    },
    ...
    openPen: function() {
        ...
        this.pen.on = true;
        this.$.pencilButton.applyStyle("background-position", "-115px -228px");
    ...
    closePen: function() {
        ...
        this.pen.on = false;
        this.$.pencilButton.applyStyle("background-position", "-39px -228px");
    ...
    startEditingText: function() {
        ...
        this.$.addTextButton.applyStyle("background-position", "-115px -311px");
        //this.textEditing.previousDrawingItem = this.whiteboard.getDrawingItem();
    ...
    cancelEditingText: function() {
        ...
        this.$.addTextButton.applyStyle("background-position", "-39px -311px");
    ...
    clearButtonMouseOver: function(inSender, inEvent) {
        this.$.clear.applyStyle("background-position", "-115px -620px");
    },

    clearButtonMouseOut: function(inSender, inEvent) {
        this.$.clear.applyStyle("background-position", "-39px -620px");
    },

    highlightEraser: function() {
        this.$.eraser.applyStyle("background-position", "-113px -574px");
    },
    ...
    eraserMouseOut: function(inSender, inEvent) {
        if (!this.eraser.on) {
            this.$.eraser.applyStyle("background-position", "-37px -574px");
        }
    },
    ...
    deleteButtonMouseOut: function(inSender, inEvent) {
        this.$.deletePage.applyStyle("background-position", "-39px -664px");
    },

    undoButtonMouseOver: function(inSender, inEvent) {
        this.$.undoButton.applyStyle("background-position", "-113px -529px");
    },

    undoButtonMouseOut: function(inSender, inEvent) {
        this.$.undoButton.applyStyle("background-position", "-37px -529px");
    },

    redoButtonMouseOver: function(inSender, inEvent) {
        this.$.redoButton.applyStyle("background-position", "-113px -485px")
    },

    redoButtonMouseOut: function(inSender, inEvent) {
        this.$.redoButton.applyStyle("background-position", "-37px -485px");
    },

    selectButtonMouseOver: function(inSender, inEvent) {
        this.$.selectButton.applyStyle("background-position", "-114px -438px");
    },

    selectButtonMouseOut: function(inSender, inEvent) {
        if (!this.selecting.on) {
            this.$.selectButton.applyStyle("background-position", "-38px -438px");
        }
    },
    ...
    highlightPenPicker: function() {
        ...
        this.$.penPicker.applyStyle("background-position", "-115px -353px");
...
//        this.$.penPicker.applyStyle("background-size", "25px,10px");
    ...
    dimPenPicker: function() {
        this.$.penPicker.applyStyle("background", "url(images/wb.svg)");
        this.$.penPicker.applyStyle("background-repeat", "no-repeat");
        this.$.penPicker.applyStyle("background-position", "-39px -353px");
        this.$.penPicker.applyStyle("background-color", "transparent");
//        this.$.penPicker.applyStyle("background-size", "25px,10px");
    },
    ...
    optionsPickerMouseOver: function(inSender, inEvent) {
        this.$.optionsMenu.applyStyle("background-position", "-113px -24px");
    },

    optionsPickerMouseOut: function(inSender, inEvent) {
        this.$.optionsMenu.applyStyle("background-position", "-37px -24px");
    },

    zoomOutMouseOver: function(inSender, inEvent) {
        this.$.zoomOutButton.applyStyle("background-position", "-113px -113px");
    },

    zoomOutMouseOut: function(inSender, inEvent) {
        this.$.zoomOutButton.applyStyle("background-position", "-37px -113px");
    },

    zoomInMouseOver: function(inSender, inEvent) {
        this.$.zoomInButton.applyStyle("background-position", "-113px -159px");
    },

    zoomInMouseOut: function(inSender, inEvent) {
        this.$.zoomInButton.applyStyle("background-position", "-37px -159px");
    },

    previewMouseOver: function(inSender, inEvent) {
        this.$.previewPages.applyStyle("background-position", "-113px -69px");
    },

    previewMouseOut: function(inSender, inEvent) {
        this.$.previewPages.applyStyle("background-position", "-37px -69px");
    },
