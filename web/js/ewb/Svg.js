...
//        }
    ...
    drawTextEx: function(data) {
        ...
        if (updateEle.get(0)) {
            ...
            $('#svggroup').append('<div id="' + data.guid + '" data-position-x="' + x + '" data-position-y="' + y + '" class="js_textContainer" style="z-index:2; width:' + width + 'px; height:' + height + 'px;position:absolute; left:' + left + 'px; top:' + top + 'px;"><textarea style="width:100%; height:100%;overflow:auto;" onselect="return false;" unselectable="on" class="text-entity" readonly="true" resizeable=false>' + data.value + '</textarea></div>');
        }
    },
    ...
    drawOuterLine: function(id) {
        ...
        var outLineHtml = '<div id="' + id + '" class="js_textContainer" style="position:absolute;background-color:#fff; border:1px dashed #0096fd; width:' + width + 'px; height:' + height + 'px; z-index:10;">',
        ...
        if (id === 'textareaFrame') {
            textareaHtml = '<textarea id="_textarea" style="z-index:2; width:' + (width - 10) + 'px; height:' + (height - 10) + 'px; margin:' + (-1 * height) + 'px 0 0 3px; float:left; overflow:auto; border:0 none; z-index:11; font-size:16px; font-size:16px; resize:none;"></textarea>';
